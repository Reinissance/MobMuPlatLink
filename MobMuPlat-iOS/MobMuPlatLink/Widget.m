...
- (void)replaceDollarZerosForGui:(Gui *)gui withInteger:(int) dollarZero {
    self.sendName = [gui replaceDollarZeroStringsIn:self.sendName withInteger:dollarZero];
    self.receiveName = [gui replaceDollarZeroStringsIn:self.receiveName withInteger:dollarZero];
    self.label.text = [gui replaceDollarZeroStringsIn:self.label.text withInteger:dollarZero];
}
